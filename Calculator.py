from tkinter import *
from Logic import show, clear, calculator
...
Button(root, text="=", width=5, height=3, font=("arial", 30, "bold"), bd=1, fg="#fff", bg="#fe9037", command=lambda: calculator()).place(x=430, y=400)
